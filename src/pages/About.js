...
const About = () => {
    ...
    return (
        <div className=' bg-black  xl:pt-0-1 lg:bg-transparent lg:pt-0-1'>
            ...
            <div className='w-full h-70-3 bg-no-repeat bg-center bg-about-module-download lg:bg-pad-about-module-download lg:h-44-8 xl:bg-pc-about-module-download xl:h-66-4'>
