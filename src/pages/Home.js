    ...
    <>
      <div className='pt-4-4 bg-black lg:pt-6-0 xl:pt-0-1'>
        ...
        <div className='w-full px-5-6 h-3-3 -mt-1-5   lg:px-18-5 lg:-mt-8-4 lg:h-5-7 relative z-10 xl:-mt-14-3'>
          <div className='bg-home-download-button bg-no-repeat bg-cover bg-center w-full h-3-3 text-white text-1-5 flex justify-center items-center cursor-pointer duration-300 transition hover:scale-105 lg:bg-pad-home-download-button lg:h-5-7 lg:text-2-3 xl:bg-pc-home-download-button xl:h-8-3'>
            Download
          </div>
        </div>
        <div className='w-full flex flex-col justify-start items-center bg-black pt-2-5 h-43-5 lg:h-42-0 lg:pt-3-6 xl:h-67-5 xl:pt-0-1 xl:mt-12-8'>
          <div className=' w-full bg-cover bg-home-module-choose bg-no-repeat bg-cover bg-center pt-2-7 lg:bg-pad-home-module-choose xl:bg-pc-home-module-choose xl:h-67-5 xl:pt-7-7'>
            ...
            <div className='relative z-10   w-full bg-home-choose-banner bg-no-repeat bg-cover bg-center flex justify-start items-center text-white h-24-8 lg:h-33-5 lg:-mt-10-0 lg:bg-pad-home-choose-banner lg:justify-center lg:items-center xl:bg-pc-home-choose-banner xl:h-57-8 xl:-mt-16-0'>
        ...
        <div className='h-47-8 bg-center bg-cover bg-no-repeat bg-cover bg-home-module-advantage relative  lg:bg-pad-home-module-advantage lg:h-80-0 xl:h-92-8 xl:bg-pc-home-module-advantage'>
          ...
          <div className='w-full px-5-6 absolute bottom-0-6 xl:bottom-0-1'>
            <div className='bg-home-download-button bg-no-repeat bg-cover bg-center w-full h-3-3 text-white text-1-5 flex justify-center items-center  lg:bg-pad-home-download-button lg:h-5-7 lg:text-2-3 xl:bg-pc-home-download-button xl:h-8-3'>
              Download
            </div>
          </div>
        </div>
