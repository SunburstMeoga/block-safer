...
const SupportAssets = () => {
    ...
    return (
        <div className='pt-4-4 bg-support-title lg:pt-6-0 xl:pt-0-1'>
            <div className='w-full bg-no-repeat bg-contain bg-bottom  bg-support-module-info h-60-1 mt-1-5 lg:bg-pad-support-module-info lg:h-72-0 lg:mt-2-5 xl:bg-pc-support-module-info xl:h-67-5  xl:mt-auto'>
            ...
            <div className='w-full h-54-1 bg-no-repeat bg-cover bg-support-module-vision bg-top bg-title-word flex flex-col justify-end items-center lg:h-57-2 lg:bg-pad-support-module-vision lg:bg-contain'>
