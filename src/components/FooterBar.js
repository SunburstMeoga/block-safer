  ...
  return (
    <>
      <div className='w-full bg-black'>
        <div className='w-full px-1-7 pt-2-9 flex justify-start items-center mb-3-2 lg:pt-4-5 lg:mb-4-2 lg:px-6-0'>
          <div className='w-3-9'>
            <img className='' src='/images/phone/footer-logo.png'></img>
          </div>
          <div className='ml-1-3 text-2-0 text-footer-logo lg:ml-2-5'>Block Saver</div>
        </div>
        <div className='w-full pl-1-7 pr-1-0 text-module-title text-2-0 leading-2-6 mb-2-1 lg:text-3-0 lg:px-6-0 lg:leading-4-4 lg:font-medium lg:mb-5-0'>
          Use Safe Neighborhood to help <br className='hidden lg:block'></br> you organize your finances today.
        </div>
        <div className='w-full pl-1-7 text-footer-logo text-1-2 font-medium leading-1-5 mb-5-1 lg:px-6-0 lg:text-2-0 lg:leading-2-8 lg:mb-4-5'>
        ...
        <div className='w-full lg:flex justify-between items-center lg:px-2-0 lg:pb-7-0'>
          <div className=''>
          ...
          <div className='hidden text-footer-logo pr-4-0 lg:block lg:mt-2-0'>
            <div className='flex justify-start items-center mb-2-0'>
